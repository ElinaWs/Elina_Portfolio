...
const projects = [
  ...
  {
    number: "02 / PERSONAL PROJECT",
    title: "The Castle",
    role: "Автор · Game Designer · Artist",
    ...
    tag: "50+ участников исследования",
    type: "castle",
    featured: true,
  },
  {
    number: "03 / INTERNSHIP",
    title: "Arklash",
    ...
    tag: "Учебная практика",
    type: "arklash",
  },
  {
    number: "04 / CLOSED PROJECT",
    title: "Cat The Wanderer",
    role: "Художник · Visual Art",
...
function App() {
  ...
  return (
    <>
      ...
      <main id="top">
        ...
        <section className="hero section">
          <div className="hero-copy reveal">
            <div className="eyebrow">
              <span>✦</span> GAME DESIGN / CONCEPT ART
            </div>

            <h1>
              Элина <span>(Wladyis)</span>
              <br />
              Алагозова
            </h1>

            <h2>
              Game Designer <i>&</i> Concept Artist
            </h2>

            <p className="hero-text">
              Создаю персонажей, миры и визуальные концепты, чтобы превращать
              идеи и внутренние истории в игровые миры.
            </p>
          ...
          <div className="hero-art reveal">
            ...
            <div className="portrait-frame">
              <img src={profileImage} alt="Элина Алагозова" />
            </div>

            <div className="floating-card card-cat">
              <span>✦</span>
              <small>dreams</small>
            </div>
        ...
        <section id="about" className="section about-section">
          ...
          <div className="about-grid">
            <div className="about-main reveal">
              ...
              <p>
                Рисую с детства — примерно с 7 лет. В игровой сфере я пока
                относительно недавно, но уже успела поработать над несколькими
                проектами в ролях аниматора, художника и концепт-художника.
              </p>
              ...
              <div className="achievement">
                ...
                <div>
                  <strong>u!skills — графический рисунок</strong>
                  <span>Высший итоговый балл курса</span>
                </div>
              </div>
            </div>
        ...
        <section id="projects" className="section projects-section">
          <div className="section-heading projects-heading reveal">
            ...
            <span className="project-count">04 проекта</span>
          </div>
          ...
          <div className="projects-grid">
            {projects.map((project) => (
              <article
                ...
                key={project.title}
              >
                <div className={`project-image image-${project.type}`}>
                  <span className="image-label">
                    {project.type === "castle"
                      ? "GAME DESIGN"
                      : project.type === "arklash"
                      ? "CONCEPT ART"
                      : project.type === "cat"
                      ? "VISUAL ART"
                      : "ANIMATION"}
                  ...
                  {project.type === "lightkeepers" && (
                    <div className="scene">
                      <span className="moon">☾</span>
                      <span className="hill hill-a"></span>
                      <span className="hill hill-b"></span>
                  ...
                  {project.type === "castle" && (
                    <div className="castle-scene">
                      <div className="castle-tower"></div>
                      <div className="castle-tower tower-right"></div>
                      <div className="castle-body"></div>
                      <div className="castle-moon">☽</div>
                    </div>
                  )}
          ...
          <div className="journey">
            ...
            {[
              [
                ...
                "Сейчас",
                "Учусь и создаю",
                "3 курс IT & Product Design, развиваю Game Design, Concept Art и 2D Art.",
              ],
              [
                "02",
                "Следующий шаг",
                "Поступить за границу",
                "Хочу продолжить образование в игровой сфере и углубиться в Game Design.",
              ],
              [
                "03",
                "Большая цель",
                "Создать свою игру",
                "Собрать знания, команду и однажды выпустить собственный игровой проект.",
              ],
            ].map(([num, small, title, text]) => (
              <div className="journey-item reveal" key={num}>
                <div className="journey-dot">{num}</div>
      ...
      <footer id="footer">
        <div>© {new Date().getFullYear()} Wladyis</div>
